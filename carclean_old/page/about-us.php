...
<?php
		...
		Template::includeTemplateHeaderBottom('About Us',array(array(Template::getPageURL('home',false),'Home'),array('#','About Us')));
?>
						...
						<div class="template-layout-50x50 template-clear-fix">
							...
							<div class="template-layout-column-left">
								...
								<ul class="template-component-list">
									...
									<li>
										<span class="template-icon-meta-check"></span>
										Book and pay for your clean <a href="#">electronically and securely</a>
									</li>
									<li>
										<span class="template-icon-meta-check"></span>
